...
import static nashorn.build.tools.nasgen.StringConstants.OBJECT_ARRAY_DESC;
import static nashorn.build.tools.nasgen.StringConstants.OBJECT_DESC;
import static nashorn.build.tools.nasgen.StringConstants.OBJ_PKG;
import static nashorn.build.tools.nasgen.StringConstants.RUNTIME_PKG;
import static nashorn.build.tools.nasgen.StringConstants.SCRIPTS_PKG;
import static nashorn.build.tools.nasgen.StringConstants.STRING_DESC;
import static nashorn.build.tools.nasgen.StringConstants.TYPE_SYMBOL;
 ...
 * annotations from the nashorn.internal.objects.annotations package.
 */
public final class MemberInfo implements Cloneable {
    ...
    // keep in sync with nashorn.internal.objects.annotations.Attribute
