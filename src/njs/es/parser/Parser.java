...
import static es.codegen.CompilerConstants.ANON_FUNCTION_PREFIX;
import static es.codegen.CompilerConstants.EVAL;
import static es.codegen.CompilerConstants.PROGRAM;
import static es.parser.TokenType.ARROW;
import static es.parser.TokenType.ASSIGN;
import static es.parser.TokenType.CASE;
import static es.parser.TokenType.CATCH;
import static es.parser.TokenType.CLASS;
import static es.parser.TokenType.COLON;
import static es.parser.TokenType.COMMARIGHT;
import static es.parser.TokenType.COMMENT;
import static es.parser.TokenType.CONST;
import static es.parser.TokenType.DECPOSTFIX;
import static es.parser.TokenType.DECPREFIX;
import static es.parser.TokenType.ELLIPSIS;
...
import static es.parser.TokenType.FINALLY;
import static es.parser.TokenType.FUNCTION;
import static es.parser.TokenType.IDENT;
import static es.parser.TokenType.IF;
import static es.parser.TokenType.IMPORT;
import static es.parser.TokenType.INCPOSTFIX;
import static es.parser.TokenType.LBRACE;
import static es.parser.TokenType.LBRACKET;
import static es.parser.TokenType.LET;
import static es.parser.TokenType.LPAREN;
import static es.parser.TokenType.MUL;
import static es.parser.TokenType.PERIOD;
import static es.parser.TokenType.RBRACE;
import static es.parser.TokenType.RBRACKET;
import static es.parser.TokenType.RPAREN;
import static es.parser.TokenType.SEMICOLON;
import static es.parser.TokenType.SPREAD_ARRAY;
import static es.parser.TokenType.STATIC;
import static es.parser.TokenType.STRING;
import static es.parser.TokenType.SUPER;
...
import static es.parser.TokenType.TERNARY;
import static es.parser.TokenType.VAR;
import static es.parser.TokenType.VOID;
import static es.parser.TokenType.WHILE;
import static es.parser.TokenType.YIELD;
import static es.parser.TokenType.YIELD_STAR;
