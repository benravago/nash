...
public final class NativeUint8Array extends ArrayBufferView {
  ...
  static final class Uint8ArrayData extends TypedArrayData<ByteBuffer> {
    ...
    Uint8ArrayData(ByteBuffer nb, int start, int end) {
   ...
   * The range specified by the begin and end values is clamped to the valid index range for the current array. If the computed length of the new
