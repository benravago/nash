...
/**
 * TernaryNode represent the ternary operator {@code ?:}. Note that for
 * control-flow calculation reasons its branch expressions (but not its test
 * expression) are always wrapped in instances of
 * {@link JoinPredecessorExpression}.
 */
@Immutable
public final class TernaryNode extends Expression {
    ...
    /**
     * Get the test expression for this ternary expression, i.e. "x" in x ? y :
     * z
     *
    ...
    /**
     * Get the true expression for this ternary expression, i.e. "y" in x ? y :
     * z
     *
    ...
    /**
     * Get the false expression for this ternary expression, i.e. "z" in x ? y :
     * z
     *
