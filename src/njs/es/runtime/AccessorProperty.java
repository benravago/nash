...
import static es.codegen.ObjectClassGenerator.createGetter;
import static es.codegen.ObjectClassGenerator.createSetter;
import static es.codegen.ObjectClassGenerator.getFieldCount;
import static es.codegen.ObjectClassGenerator.getFieldName;
...
public class AccessorProperty extends Property {
  ...
  private MethodHandle debug(final MethodHandle mh, final Class<?> forType, final Class<?> type, final String tag) {
    ...
    return context.addLoggingToHandle(ObjectClassGenerator.class,
            Level.INFO,
            mh,
            0,
            true,
  ...
  private MethodHandle debugReplace(final Class<?> oldType, final Class<?> newType, final PropertyMap oldMap, final PropertyMap newMap) {
    ...
    mh = context.addLoggingToHandle(ObjectClassGenerator.class,
            Level.FINEST,
            mh,
            Integer.MAX_VALUE,
            false,
      ...
      @Override
      public String get() {
        return "Setting map " + Hex.id(oldMap) + " => " + Hex.id(newMap) + " " + oldMap + " => " + newMap;
      }
    });
    return mh;
  }
