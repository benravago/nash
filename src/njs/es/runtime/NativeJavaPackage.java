 ...
 * Normally, three instances of this class are exposed as built-in objects in Nashorn: {@code "Packages"}, {@code "java"}, and {@code "javax"}. Typical usages are:
 * <pre>
 ...
 * </pre>
 * You can also use {@link es.objects.NativeJava#type(Object, Object)} to access Java classes.
...
public final class NativeJavaPackage extends ScriptObject {
  ...
  /**
   * Public constructor to be accessible from {@link es.objects.Global}
  ...
  public boolean equals(Object other) {
    return (other instanceof NativeJavaPackage njp) && name.equals(njp.name);
  }
  ...
  public Object getDefaultValue(Class<?> hint) {
    return (hint == String.class) ? toString() : super.getDefaultValue(hint);
  }
  ...
  static GuardedInvocation createClassNotFoundInvocation(CallSiteDescriptor desc) {
  ...
  static void classNotFound(NativeJavaPackage pkg) throws ClassNotFoundException {
  ...
  Object createProperty(String propertyName) {
    ...
    var propertyValue = (javaClass == null) ? new NativeJavaPackage(fullName, getProto()) : StaticClass.forClass(javaClass);
