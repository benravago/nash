...
try{
  if(f1() !== Object.prototype){
    warn('#1: arguments.constructor.prototype === Object.prototype');
  }
}
catch(e){
  warn("#1: arguments doesn't exists");
}
...
try{
  if(f2() !== Object.prototype){
    warn('#2: arguments.constructor.prototype === Object.prototype');
  }
}
catch(e){
  warn("#2: arguments doesn't exists");
}
