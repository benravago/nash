...
if(Number.prototype.toString(31) !== "0"){
  warn('#1: Number.prototype.toString(31) === "0"');
}

//CHECK#2
if((new Number()).toString(31) !== "0"){
  warn('#2: (new Number()).toString(31) === "0"');
}

//CHECK#3
if((new Number(0)).toString(31) !== "0"){
  warn('#3: (new Number(0)).toString(31) === "0"');
}

//CHECK#4
if((new Number(-1)).toString(31) !== "-1"){
  warn('#4: (new Number(-1)).toString(31) === "-1"');
}

//CHECK#5
if((new Number(1)).toString(31) !== "1"){
  warn('#5: (new Number(1)).toString(31) === "1"');
}

//CHECK#6
if((new Number(Number.NaN)).toString(31) !== "NaN"){
  warn('#6: (new Number(Number.NaN)).toString(31) === "NaN"');
}

//CHECK#7
if((new Number(Number.POSITIVE_INFINITY)).toString(31) !== "Infinity"){
  warn('#7: (new Number(Number.POSITIVE_INFINITY)).toString(31) === "Infinity"');
}

//CHECK#8
if((new Number(Number.NEGATIVE_INFINITY)).toString(31) !== "-Infinity"){
  warn('#8: (new Number(Number.NEGATIVE_INFINITY)).toString(31) === "-Infinity"');
}
