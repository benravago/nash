...
if(Number.prototype.toString(32) !== "0"){
  warn('#1: Number.prototype.toString(32) === "0"');
}

//CHECK#2
if((new Number()).toString(32) !== "0"){
  warn('#2: (new Number()).toString(32) === "0"');
}

//CHECK#3
if((new Number(0)).toString(32) !== "0"){
  warn('#3: (new Number(0)).toString(32) === "0"');
}

//CHECK#4
if((new Number(-1)).toString(32) !== "-1"){
  warn('#4: (new Number(-1)).toString(32) === "-1"');
}

//CHECK#5
if((new Number(1)).toString(32) !== "1"){
  warn('#5: (new Number(1)).toString(32) === "1"');
}

//CHECK#6
if((new Number(Number.NaN)).toString(32) !== "NaN"){
  warn('#6: (new Number(Number.NaN)).toString(32) === "NaN"');
}

//CHECK#7
if((new Number(Number.POSITIVE_INFINITY)).toString(32) !== "Infinity"){
  warn('#7: (new Number(Number.POSITIVE_INFINITY)).toString(32) === "Infinity"');
}

//CHECK#8
if((new Number(Number.NEGATIVE_INFINITY)).toString(32) !== "-Infinity"){
  warn('#8: (new Number(Number.NEGATIVE_INFINITY)).toString(32) === "-Infinity"');
}
