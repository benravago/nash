...
if(Number.prototype.valueOf("argument") !== 0){
  warn('#1: Number.prototype.valueOf("argument") === 0');
}

//CHECK#2
if((new Number()).valueOf("argument") !== 0){
  warn('#2: (new Number()).valueOf("argument") === 0');
}

//CHECK#3
if((new Number(0)).valueOf("argument") !== 0){
  warn('#3: (new Number(0)).valueOf("argument") === 0');
}

//CHECK#4
if((new Number(-1)).valueOf("argument") !== -1){
  warn('#4: (new Number(-1)).valueOf("argument") === -1');
}

//CHECK#5
if((new Number(1)).valueOf("argument") !== 1){
  warn('#5: (new Number(1)).valueOf("argument") === 1');
}

//CHECK#6
if(!isNaN((new Number(Number.NaN)).valueOf("argument"))){
  warn('#6: (new Number(Number.NaN)).valueOf("argument") === NaN');
}

//CHECK#7
if((new Number(Number.POSITIVE_INFINITY)).valueOf("argument") !== Number.POSITIVE_INFINITY){
  warn('#7: (new Number(Number.POSITIVE_INFINITY)).valueOf("argument") === Infinity');
}

//CHECK#8
if((new Number(Number.NEGATIVE_INFINITY)).valueOf("argument") !== Number.NEGATIVE_INFINITY){
  warn('#8: (new Number(Number.NEGATIVE_INFINITY)).valueOf("argument") === -Infinity');
}
