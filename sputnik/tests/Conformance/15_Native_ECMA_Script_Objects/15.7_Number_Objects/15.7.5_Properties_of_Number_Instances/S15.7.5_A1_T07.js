...
if((new Number()).hasOwnProperty("toPrecision") !== false){
  warn('#1: Number instance must have no special property "toPrecision"');
}

//CHECK#2
if((new Number()).toPrecision !== Number.prototype.toPrecision){
  warn('#2: Number instance property "toPrecision" must be inherited from Number prototype object');
}
