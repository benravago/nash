...
if((new Number()).hasOwnProperty("constructor") !== false){
  warn('#1: Number instance must have no special property "constructor"');
}

//CHECK#2
if((new Number()).constructor !== Number.prototype.constructor){
  warn('#2: Number instance property "constructor" must be inherited from Number prototype object');
}
