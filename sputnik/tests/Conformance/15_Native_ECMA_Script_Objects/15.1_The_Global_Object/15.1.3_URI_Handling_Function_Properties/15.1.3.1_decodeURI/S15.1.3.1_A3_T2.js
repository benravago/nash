...
//CHECK#1
if (decodeURI("%3b") !== "%3b") {
  warn('#1: decodeURI("%3b") equal "%3b", not ";" or "%3B"');
}

//CHECK#2
if (decodeURI("%2f") !== "%2f") {
  warn('#2: decodeURI("%2f") equal "%2f", not "/" or "%2F"');
}

//CHECK#3
if (decodeURI("%3f") !== "%3f") {
  warn('#3: decodeURI("%3f") equal "%3f", not "?" or "%3F"');
}

//CHECK#4
if (decodeURI("%3a") !== "%3a") {
  warn('#4: decodeURI("%3a") equal "%3a", not ":" or "%3A"');
}
...
//CHECK#7
if (decodeURI("%3d") !== "%3d") {
  warn('#7.1: decodeURI("%3d") equal "%3d", not "=" or "%3D"');
}

//CHECK#8
if (decodeURI("%2b") !== "%2b") {
  warn('#8.1: decodeURI("%2b") equal "%2b", not "+" or "%2B"');
}
...
//CHECK#10
if (decodeURI("%2c") !== "%2c") {
  warn('#10: decodeURI("%2c") equal "%2c", not "," or "%2C"');
}
