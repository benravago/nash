...
if (parseInt("11", new String("2")) !== parseInt("11", 2)) {
  warn('#1: parseInt("11", new String("2")) === parseInt("11", 2). Actual: ' + (parseInt("11", new String("2"))));
}

//CHECK#2
if (parseInt("11", new String("Infinity")) !== parseInt("11", Infinity)) {
  warn('#2: parseInt("11", new String("Infinity")) === parseInt("11", Infinity). Actual: ' + (parseInt("11", new String("Infinity"))));
}
