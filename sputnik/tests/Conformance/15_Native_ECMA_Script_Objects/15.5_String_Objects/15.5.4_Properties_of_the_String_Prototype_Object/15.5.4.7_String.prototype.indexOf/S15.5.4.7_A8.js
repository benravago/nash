...
if (!(String.prototype.indexOf.hasOwnProperty('length'))) {
  warn('#0: String.prototype.indexOf.hasOwnProperty(\'length\') return true. Actual: '+String.prototype.indexOf.hasOwnProperty('length')); 
}
//
//////////////////////////////////////////////////////////////////////////////
...
if (String.prototype.indexOf.propertyIsEnumerable('length')) {
  warn('#1: String.prototype.indexOf.propertyIsEnumerable(\'length\') return false');
}
//
//////////////////////////////////////////////////////////////////////////////
...
if (count !== 0) {
  warn('#2: count=0; for (p in String.prototype.indexOf){if (p==="length") count++;}; count === 0. Actual: '+count ); 
}
//
//////////////////////////////////////////////////////////////////////////////
