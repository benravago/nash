...
if (__instance.concat(false,true) !== "42falsetrue") {
  warn('#1: __instance = new Object(42); __instance.concat = String.prototype.concat;  __instance.concat(false,true) === "42falsetrue". Actual: '+__instance.concat(false,true) ); 
}
//
//////////////////////////////////////////////////////////////////////////////
