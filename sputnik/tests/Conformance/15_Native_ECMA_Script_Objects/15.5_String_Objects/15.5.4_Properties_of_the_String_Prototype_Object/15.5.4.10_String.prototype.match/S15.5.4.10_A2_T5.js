...
if (__string.match(/\D{2}/g).length!== 2) {
  warn('#1: __string = "123456abcde7890"; __string.match(/\\D{2}/g).length=== 2. Actual: '+__string.match(/\D{2}/g).length);
}
//
//////////////////////////////////////////////////////////////////////////////
...
for(var mi=0; mi<__matches.length; mi++) {
  if (__string.match(/\D{2}/g)[mi]!==__matches[mi]) {
    warn('#2.'+mi+': __matches=["ab", "cd"]; __string = "123456abcde7890"; __string.match(/\\D{2}/g)['+mi+']===__matches['+mi+']. Actual: '+__string.match(/\D{2}/g)[mi]);
  }
}
//
//////////////////////////////////////////////////////////////////////////////
