...
if (__string.match(/34/g).length!== 3) {
  warn('#1: __string = "343443444"; __string.match(/34/g).length=== 3. Actual: '+__string.match(/34/g).length);
}
//
//////////////////////////////////////////////////////////////////////////////
...
for(var mi=0; mi<__matches.length; mi++) {
  if (__string.match(/34/g)[mi]!==__matches[mi]) {
    warn('#2.'+mi+': __matches=["34","34","34"]; __string = "343443444"; __string.match(/34/g)['+mi+']===__matches['+mi+']. Actual: '+__string.match(/34/g)[mi]);
  }
}
//
//////////////////////////////////////////////////////////////////////////////
