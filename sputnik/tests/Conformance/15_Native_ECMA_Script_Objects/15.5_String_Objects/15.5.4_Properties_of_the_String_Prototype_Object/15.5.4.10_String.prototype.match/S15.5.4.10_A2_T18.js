...
if (__num.match(__re)[0]!== "02") {
  warn('#1: __num.match(__re)[0]=== "02". Actual: '+__num.match(__re)[0]);
}
//
//////////////////////////////////////////////////////////////////////////////
...
if (__num.match(__re).length !==1) {
  warn('#2: __num.match(__re).length ===1. Actual: '+__num.match(__re).length );
}
//
//////////////////////////////////////////////////////////////////////////////
...
if (__num.match(__re).index !==1) {
  warn('#3: __num.match(__re).index ===1. Actual: '+__num.match(__re).index );
}
//
//////////////////////////////////////////////////////////////////////////////
...
if (__num.match(__re).input !==String(__num)) {
  warn('#4: __num.match(__re).input ===String(__num). Actual: '+__num.match(__re).input );
}
//
//////////////////////////////////////////////////////////////////////////////
