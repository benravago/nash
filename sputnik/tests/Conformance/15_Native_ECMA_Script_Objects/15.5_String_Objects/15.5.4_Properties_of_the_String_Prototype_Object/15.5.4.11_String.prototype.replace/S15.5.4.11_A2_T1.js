...
if (__str.replace(__re,'sch')!=='She sells seaschells by the seaschore.') {
  warn('#1: var __str = \'She sells seashells by the seashore.\'; var __re = /sh/g; __str.replace(__re,\'sch\')===\'She sells seaschells by the seaschore.\'. Actual: '+__str.replace(__re,'sch'));
}
//
//////////////////////////////////////////////////////////////////////////////
