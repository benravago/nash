...
if(!(str.valueOf() == str.toString()))
  warn('#1: str = new String(),str.valueOf() == str.toString()');

//CHECK#2
str = new String(true);
if(!(str.valueOf() == str.toString()))
  warn('#2: str = new String(true),str.valueOf() == str.toString()');

//CHECK#3
str = new String(false);
if(!(str.valueOf() == str.toString()))
  warn('#3: str = new String(false),str.valueOf() == str.toString()');

//CHECK#4
str = new String(Math.PI);
if(!(str.valueOf() == str.toString()))
  warn('#4: str = new String(Math.PI),str.valueOf() == str.toString()');
