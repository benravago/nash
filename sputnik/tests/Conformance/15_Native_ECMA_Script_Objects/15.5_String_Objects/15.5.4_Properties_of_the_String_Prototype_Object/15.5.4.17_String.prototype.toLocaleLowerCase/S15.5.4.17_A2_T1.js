...
if ("Hello, WoRlD!".toLocaleLowerCase() !== "hello, world!") {
  warn('#1: "Hello, WoRlD!".toLocaleLowerCase() === "hello, world!". Actual: '+("Hello, WoRlD!".toLocaleLowerCase()) );
}
//
//////////////////////////////////////////////////////////////////////////////
...
if ("Hello, WoRlD!".toLocaleLowerCase() !== String("hello, world!")) {
  warn('#2: "Hello, WoRlD!".toLocaleLowerCase() === String("hello, world!"). Actual: '+("Hello, WoRlD!".toLocaleLowerCase()) );
}
//
//////////////////////////////////////////////////////////////////////////////
...
if ("Hello, WoRlD!".toLocaleLowerCase() === new String("hello, world!")) {
  warn('#3: "Hello, WoRlD!".toLocaleLowerCase() !== new String("hello, world!")');
}
//
//////////////////////////////////////////////////////////////////////////////
