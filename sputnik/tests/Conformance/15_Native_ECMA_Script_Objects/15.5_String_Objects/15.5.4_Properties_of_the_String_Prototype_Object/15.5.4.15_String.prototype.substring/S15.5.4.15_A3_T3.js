...
if (__instance.substring(true, false) !== "1") {
  warn('#1: __instance = new Array(1,2,3,4,5); __instance.substring = String.prototype.substring; __instance.substring(true, false) === "1". Actual: '+__instance.substring(true, false) );
}
//
//////////////////////////////////////////////////////////////////////////////
