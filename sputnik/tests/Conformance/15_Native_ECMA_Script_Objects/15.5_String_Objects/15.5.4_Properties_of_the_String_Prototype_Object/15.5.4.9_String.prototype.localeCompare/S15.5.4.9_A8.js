...
if (!(String.prototype.localeCompare.hasOwnProperty('length'))) {
  warn('#0: String.prototype.localeCompare.hasOwnProperty(\'length\') return true. Actual: '+String.prototype.localeCompare.hasOwnProperty('length'));
}
//
//////////////////////////////////////////////////////////////////////////////
...
if (String.prototype.localeCompare.propertyIsEnumerable('length')) {
  warn('#1: String.prototype.localeCompare.propertyIsEnumerable(\'length\') return false');
}
//
//////////////////////////////////////////////////////////////////////////////
...
if (count !== 0) {
  warn('#2: count=0; for (p in String.prototype.localeCompare){if (p==="length") count++;}; count === 0. Actual: '+count );
}
//
//////////////////////////////////////////////////////////////////////////////
