...
if (__split.constructor !== Array) {
  warn('#1: var __string = new String("hello"); var __re = /l/; __split = __string.split(__re,1); __split.constructor === Array. Actual: '+__split.constructor );
}
//
//////////////////////////////////////////////////////////////////////////////
...
//CHECK#2
if (__split.length !== 1) {
  warn('#2: var __string = new String("hello"); var __re = /l/; __split = __string.split(__re,1); __split.length === 1. Actual: '+__split.length );
}
//
//////////////////////////////////////////////////////////////////////////////
...
//CHECK#3
if (__split[0] !== "he") {
  warn('#3: var __string = new String("hello"); var __re = /l/; __split = __string.split(__re,1); __split[0] === "he". Actual: '+__split[0] );
}
//
//////////////////////////////////////////////////////////////////////////////
