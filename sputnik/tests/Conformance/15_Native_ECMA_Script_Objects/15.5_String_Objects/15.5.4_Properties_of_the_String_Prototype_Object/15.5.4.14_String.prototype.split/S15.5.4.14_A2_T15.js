...
//CHECK#2
if (__split.length !== 0) {
  warn('#2: var __string = new String(); __split = __string.split(""); __split.length === 0. Actual: '+__split.length );
}
//
//////////////////////////////////////////////////////////////////////////////
...
if (__split[0] !== undefined) {
  warn('#3: var __string = new String(); __split = __string.split(""); __split[0] === undefined. Actual: '+__split[0] );
}
//
//////////////////////////////////////////////////////////////////////////////
