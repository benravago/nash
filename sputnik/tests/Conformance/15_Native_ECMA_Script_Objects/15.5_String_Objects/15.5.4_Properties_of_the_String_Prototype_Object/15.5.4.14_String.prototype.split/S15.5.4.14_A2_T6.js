...
if (__split.constructor !== Array) {
  warn('#1: var __string = new String("one-1 two-2 three-3"); __split = __string.split(\'\'); __split.constructor === Array. Actual: '+__split.constructor );
}
//
//////////////////////////////////////////////////////////////////////////////
...
if (__split.length !== __string.length) {
  warn('#2: var __string = new String("one-1 two-2 three-3"); __split = __string.split(\'\'); __split.length === __string.length. Actual: '+__split.length );
}
//
//////////////////////////////////////////////////////////////////////////////
...
for ( var i = 0; i < __string.length; i++ ) {
    if (__split[i]!==__string.charAt(i)) {
      warn('#3.'+i+': var __string = new String("one-1 two-2 three-3"); __split = __string.split(\'\'); __split['+i+']===__string.charAt('+i+'). Actual: '+__split[i]);
    }
}
//
//////////////////////////////////////////////////////////////////////////////
