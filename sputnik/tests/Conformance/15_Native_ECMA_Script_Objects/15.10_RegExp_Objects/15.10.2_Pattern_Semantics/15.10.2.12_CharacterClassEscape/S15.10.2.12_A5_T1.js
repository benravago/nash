...
if (i0.replace(/\d+/g, "") !== o0) {
  warn("#0: Error matching character class \d between character 0 and 3ff");
}
...
if (i1.replace(/\d+/g, "") !== o1) {
  warn("#1: Error matching character class \d between character 400 and 7ff");
}
...
if (i2.replace(/\d+/g, "") !== o2) {
  warn("#2: Error matching character class \d between character 800 and bff");
}
...
if (i3.replace(/\d+/g, "") !== o3) {
  warn("#3: Error matching character class \d between character c00 and fff");
}
...
if (i4.replace(/\d+/g, "") !== o4) {
  warn("#4: Error matching character class \d between character 1000 and 13ff");
}
...
if (i5.replace(/\d+/g, "") !== o5) {
  warn("#5: Error matching character class \d between character 1400 and 17ff");
}
...
if (i6.replace(/\d+/g, "") !== o6) {
  warn("#6: Error matching character class \d between character 1800 and 1bff");
}
...
if (i7.replace(/\d+/g, "") !== o7) {
  warn("#7: Error matching character class \d between character 1c00 and 1fff");
}
...
if (i8.replace(/\d+/g, "") !== o8) {
  warn("#8: Error matching character class \d between character 2000 and 23ff");
}
...
if (i9.replace(/\d+/g, "") !== o9) {
  warn("#9: Error matching character class \d between character 2400 and 27ff");
}
...
if (i10.replace(/\d+/g, "") !== o10) {
  warn("#10: Error matching character class \d between character 2800 and 2bff");
}
...
if (i11.replace(/\d+/g, "") !== o11) {
  warn("#11: Error matching character class \d between character 2c00 and 2fff");
}
...
if (i12.replace(/\d+/g, "") !== o12) {
  warn("#12: Error matching character class \d between character 3000 and 33ff");
}
...
if (i13.replace(/\d+/g, "") !== o13) {
  warn("#13: Error matching character class \d between character 3400 and 37ff");
}
...
if (i14.replace(/\d+/g, "") !== o14) {
  warn("#14: Error matching character class \d between character 3800 and 3bff");
}
...
if (i15.replace(/\d+/g, "") !== o15) {
  warn("#15: Error matching character class \d between character 3c00 and 3fff");
}
...
if (i16.replace(/\d+/g, "") !== o16) {
  warn("#16: Error matching character class \d between character 4000 and 43ff");
}
...
if (i17.replace(/\d+/g, "") !== o17) {
  warn("#17: Error matching character class \d between character 4400 and 47ff");
}
...
if (i18.replace(/\d+/g, "") !== o18) {
  warn("#18: Error matching character class \d between character 4800 and 4bff");
}
...
if (i19.replace(/\d+/g, "") !== o19) {
  warn("#19: Error matching character class \d between character 4c00 and 4fff");
}
...
if (i20.replace(/\d+/g, "") !== o20) {
  warn("#20: Error matching character class \d between character 5000 and 53ff");
}
...
if (i21.replace(/\d+/g, "") !== o21) {
  warn("#21: Error matching character class \d between character 5400 and 57ff");
}
...
if (i22.replace(/\d+/g, "") !== o22) {
  warn("#22: Error matching character class \d between character 5800 and 5bff");
}
...
if (i23.replace(/\d+/g, "") !== o23) {
  warn("#23: Error matching character class \d between character 5c00 and 5fff");
}
...
if (i24.replace(/\d+/g, "") !== o24) {
  warn("#24: Error matching character class \d between character 6000 and 63ff");
}
...
if (i25.replace(/\d+/g, "") !== o25) {
  warn("#25: Error matching character class \d between character 6400 and 67ff");
}
...
if (i26.replace(/\d+/g, "") !== o26) {
  warn("#26: Error matching character class \d between character 6800 and 6bff");
}
...
if (i27.replace(/\d+/g, "") !== o27) {
  warn("#27: Error matching character class \d between character 6c00 and 6fff");
}
...
if (i28.replace(/\d+/g, "") !== o28) {
  warn("#28: Error matching character class \d between character 7000 and 73ff");
}
...
if (i29.replace(/\d+/g, "") !== o29) {
  warn("#29: Error matching character class \d between character 7400 and 77ff");
}
...
if (i30.replace(/\d+/g, "") !== o30) {
  warn("#30: Error matching character class \d between character 7800 and 7bff");
}
...
if (i31.replace(/\d+/g, "") !== o31) {
  warn("#31: Error matching character class \d between character 7c00 and 7fff");
}
...
if (i32.replace(/\d+/g, "") !== o32) {
  warn("#32: Error matching character class \d between character 8000 and 83ff");
}
...
if (i33.replace(/\d+/g, "") !== o33) {
  warn("#33: Error matching character class \d between character 8400 and 87ff");
}
...
if (i34.replace(/\d+/g, "") !== o34) {
  warn("#34: Error matching character class \d between character 8800 and 8bff");
}
...
if (i35.replace(/\d+/g, "") !== o35) {
  warn("#35: Error matching character class \d between character 8c00 and 8fff");
}
...
if (i36.replace(/\d+/g, "") !== o36) {
  warn("#36: Error matching character class \d between character 9000 and 93ff");
}
...
if (i37.replace(/\d+/g, "") !== o37) {
  warn("#37: Error matching character class \d between character 9400 and 97ff");
}
...
if (i38.replace(/\d+/g, "") !== o38) {
  warn("#38: Error matching character class \d between character 9800 and 9bff");
}
...
if (i39.replace(/\d+/g, "") !== o39) {
  warn("#39: Error matching character class \d between character 9c00 and 9fff");
}
...
if (i40.replace(/\d+/g, "") !== o40) {
  warn("#40: Error matching character class \d between character a000 and a3ff");
}
...
if (i41.replace(/\d+/g, "") !== o41) {
  warn("#41: Error matching character class \d between character a400 and a7ff");
}
...
if (i42.replace(/\d+/g, "") !== o42) {
  warn("#42: Error matching character class \d between character a800 and abff");
}
...
if (i43.replace(/\d+/g, "") !== o43) {
  warn("#43: Error matching character class \d between character ac00 and afff");
}
...
if (i44.replace(/\d+/g, "") !== o44) {
  warn("#44: Error matching character class \d between character b000 and b3ff");
}
...
if (i45.replace(/\d+/g, "") !== o45) {
  warn("#45: Error matching character class \d between character b400 and b7ff");
}
...
if (i46.replace(/\d+/g, "") !== o46) {
  warn("#46: Error matching character class \d between character b800 and bbff");
}
...
if (i47.replace(/\d+/g, "") !== o47) {
  warn("#47: Error matching character class \d between character bc00 and bfff");
}
...
if (i48.replace(/\d+/g, "") !== o48) {
  warn("#48: Error matching character class \d between character c000 and c3ff");
}
...
if (i49.replace(/\d+/g, "") !== o49) {
  warn("#49: Error matching character class \d between character c400 and c7ff");
}
...
if (i50.replace(/\d+/g, "") !== o50) {
  warn("#50: Error matching character class \d between character c800 and cbff");
}
...
if (i51.replace(/\d+/g, "") !== o51) {
  warn("#51: Error matching character class \d between character cc00 and cfff");
}
...
if (i52.replace(/\d+/g, "") !== o52) {
  warn("#52: Error matching character class \d between character d000 and d3ff");
}
...
if (i53.replace(/\d+/g, "") !== o53) {
  warn("#53: Error matching character class \d between character d400 and d7ff");
}
...
if (i54.replace(/\d+/g, "") !== o54) {
  warn("#54: Error matching character class \d between character d800 and dbff");
}
...
if (i55.replace(/\d+/g, "") !== o55) {
  warn("#55: Error matching character class \d between character dc00 and dfff");
}
...
if (i56.replace(/\d+/g, "") !== o56) {
  warn("#56: Error matching character class \d between character e000 and e3ff");
}
...
if (i57.replace(/\d+/g, "") !== o57) {
  warn("#57: Error matching character class \d between character e400 and e7ff");
}
...
if (i58.replace(/\d+/g, "") !== o58) {
  warn("#58: Error matching character class \d between character e800 and ebff");
}
...
if (i59.replace(/\d+/g, "") !== o59) {
  warn("#59: Error matching character class \d between character ec00 and efff");
}
...
if (i60.replace(/\d+/g, "") !== o60) {
  warn("#60: Error matching character class \d between character f000 and f3ff");
}
...
if (i61.replace(/\d+/g, "") !== o61) {
  warn("#61: Error matching character class \d between character f400 and f7ff");
}
...
if (i62.replace(/\d+/g, "") !== o62) {
  warn("#62: Error matching character class \d between character f800 and fbff");
}
...
if (i63.replace(/\d+/g, "") !== o63) {
  warn("#63: Error matching character class \d between character fc00 and ffff");
}
