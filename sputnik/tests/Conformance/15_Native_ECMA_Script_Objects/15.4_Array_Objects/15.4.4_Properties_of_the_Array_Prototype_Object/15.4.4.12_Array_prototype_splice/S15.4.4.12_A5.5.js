...
if (Array.propertyIsEnumerable('splice') !== false) {
  warn('#1: Array.propertyIsEnumerable(\'splice\') === false. Actual: ' + (Array.propertyIsEnumerable('splice')));
}
...
if (result !== true) {
  warn('#2: result = true; for (p in Array) { if (p === "splice") result = false; }  result === true;');
}
