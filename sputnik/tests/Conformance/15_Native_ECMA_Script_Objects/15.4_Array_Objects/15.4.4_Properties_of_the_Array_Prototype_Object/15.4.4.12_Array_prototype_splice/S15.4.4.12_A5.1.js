...
if (Array.prototype.splice.propertyIsEnumerable('length') !== false) {
  warn('#1: Array.prototype.splice.propertyIsEnumerable(\'length\') === false. Actual: ' + (Array.prototype.splice.propertyIsEnumerable('length')));
}
...
if (result !== true) {
  warn('#2: result = true; for (p in Array.splice) { if (p === "length") result = false; }  result === true;');
}
