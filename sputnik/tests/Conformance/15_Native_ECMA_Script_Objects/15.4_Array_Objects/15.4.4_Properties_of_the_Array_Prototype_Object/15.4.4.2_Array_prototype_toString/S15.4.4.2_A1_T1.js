...
if (x.toString() !== x.join()) {
  warn('#1.1: x = new Array(); x.toString() === x.join(). Actual: ' + (x.toString()));
}  else {
  if (x.toString() !== "") {
    warn('#1.2: x = new Array(); x.toString() === "". Actual: ' + (x.toString()));
  }  
}  
...
x.length = 0;
if (x.toString() !== x.join()) {
  warn('#2.1: x = []; x[0] = 1; x.length = 0; x.toString() === x.join(). Actual: ' + (x.toString()));
} else {
  if (x.toString() !== "") {
    warn('#2.2: x = []; x[0] = 1; x.length = 0; x.toString() === "". Actual: ' + (x.toString()));
  }  
}    
