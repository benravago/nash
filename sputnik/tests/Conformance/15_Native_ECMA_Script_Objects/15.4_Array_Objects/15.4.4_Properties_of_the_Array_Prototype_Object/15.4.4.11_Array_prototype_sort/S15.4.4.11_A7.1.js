...
if (Array.prototype.sort.propertyIsEnumerable('length') !== false) {
  warn('#1: Array.prototype.sort.propertyIsEnumerable(\'length\') === false. Actual: ' + (Array.prototype.sort.propertyIsEnumerable('length')));
}
...
if (result !== true) {
  warn('#2: result = true; for (p in Array.sort) { if (p === "length") result = false; }  result === true;');
}
