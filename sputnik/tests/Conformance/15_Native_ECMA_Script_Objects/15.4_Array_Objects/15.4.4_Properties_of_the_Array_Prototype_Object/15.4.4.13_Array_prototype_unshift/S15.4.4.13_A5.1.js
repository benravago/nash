...
if (Array.prototype.unshift.propertyIsEnumerable('length') !== false) {
  warn('#1: Array.prototype.unshift.propertyIsEnumerable(\'length\') === false. Actual: ' + (Array.prototype.unshift.propertyIsEnumerable('length')));
}
...
if (result !== true) {
  warn('#2: result = true; for (p in Array.unshift) { if (p === "length") result = false; }  result === true;');
}
