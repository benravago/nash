...
if (Array.propertyIsEnumerable('unshift') !== false) {
  warn('#1: Array.propertyIsEnumerable(\'unshift\') === false. Actual: ' + (Array.propertyIsEnumerable('unshift')));
}
...
if (result !== true) {
  warn('#2: result = true; for (p in Array) { if (p === "unshift") result = false; }  result === true;');
}
