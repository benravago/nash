...
var x = new Array(0); 
if (x.length !== 0) {
  warn('#1: var x = new Array(0); x.length === 0. Actual: ' + (x.length));
}

//CHECK#2
var x = new Array(1); 
if (x.length !== 1) {
  warn('#2: var x = new Array(1); x.length === 1. Actual: ' + (x.length));
}   

//CHECK#3
var x = new Array(4294967295); 
if (x.length !== 4294967295) {
  warn('#3: var x = new Array(4294967295); x.length === 4294967295. Actual: ' + (x.length));
} 
