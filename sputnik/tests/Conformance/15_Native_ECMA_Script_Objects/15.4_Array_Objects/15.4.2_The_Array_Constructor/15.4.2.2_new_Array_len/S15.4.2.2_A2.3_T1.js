...
//CHECK#1 
if (x.length !== 1) {
  warn('#1: var x = new Array(null); x.length === 1. Actual: ' + (x.length));
}

//CHECK#2
if (x[0] !== null) {
  warn('#2: var x = new Array(null); x[0] === null. Actual: ' + (x[0]));
}
...
//CHECK#3 
if (x.length !== 1) {
  warn('#3: var x = new Array(undefined); x.length === 1. Actual: ' + (x.length));
}

//CHECK#4
if (x[0] !== undefined) {
  warn('#4: var x = new Array(undefined); x[0] === undefined. Actual: ' + (x[0]));
}
