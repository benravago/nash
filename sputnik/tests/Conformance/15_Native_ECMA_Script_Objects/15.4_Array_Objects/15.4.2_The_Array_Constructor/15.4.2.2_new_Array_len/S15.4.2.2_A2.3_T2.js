...
//CHECK#1 
if (x.length !== 1) {
  warn('#1: var x = new Array(true); x.length === 1. Actual: ' + (x.length));
}

//CHECK#2
if (x[0] !== true) {
  warn('#2: var x = new Array(true); x[0] === true. Actual: ' + (x[0]));
}
...
//CHECK#3 
if (x.length !== 1) {
  warn('#3: var obj = new Boolean(false); var x = new Array(obj); x.length === 1. Actual: ' + (x.length));
}

//CHECK#4
if (x[0] !== obj) {
  warn('#4: var obj = new Boolean(false); var x = new Array(obj); x[0] === obj. Actual: ' + (x[0]));
}
