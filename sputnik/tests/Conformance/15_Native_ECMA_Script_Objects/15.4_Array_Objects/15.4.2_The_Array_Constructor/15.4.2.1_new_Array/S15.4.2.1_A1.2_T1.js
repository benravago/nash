...
if (x.getClass() !== "[object " + "Array" + "]") {
  warn('#1: var x = new Array(); x.getClass = Object.prototype.toString; x is Array object. Actual: ' + (x.getClass()));
}
...
x.getClass = Object.prototype.toString;
if (x.getClass() !== "[object " + "Array" + "]") {
  warn('#2: var x = new Array(0,1,2); x.getClass = Object.prototype.toString; x is Array object. Actual: ' + (x.getClass()));
}
