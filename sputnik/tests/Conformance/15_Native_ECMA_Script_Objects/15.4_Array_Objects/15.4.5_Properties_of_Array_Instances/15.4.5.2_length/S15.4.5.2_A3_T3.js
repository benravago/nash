...
if (x.length !== 4294967295) {  
  warn('#1: x = []; x.length = 4294967295; x.length === 4294967295');    
}
...
try {
  x = [];
  x.length = 4294967296;
  warn('#2.1: x = []; x.length = 4294967296 throw RangeError. Actual: x.length === ' + (x.length));
} catch(e) {    
  if ((e instanceof RangeError) !== true) {
    warn('#2.2: x = []; x.length = 4294967296 throw RangeError. Actual: ' + (e));
  }    
}
