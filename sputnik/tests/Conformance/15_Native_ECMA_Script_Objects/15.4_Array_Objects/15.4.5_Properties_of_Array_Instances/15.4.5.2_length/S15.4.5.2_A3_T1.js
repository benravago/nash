...
x.length = 1;
if (x.length !== 1) {  
  warn('#1: x = []; x.length = 1; x.length === 1. Actual: ' + (x.length));    
}
...
x.length = 10;
if (x.length !== 10) {      
  warn('#2: x = []; x.length = 1; x[5] = 1; x.length = 10; x.length === 10. Actual: ' + (x.length));
}

//CHECK#3
if (x[5] !== 1) {      
  warn('#3: x = []; x.length = 1; x[5] = 1; x.length = 10; x[5] = 1');
}
