...
x.length = 4;
if (x[4] !== undefined) {  
  warn('#1: x = [0,,2,,4]; x.length = 4; x[4] === undefined. Actual: ' + (x[4]));    
}

//CHECK#2
x.length = 3;
if (x[3] !== undefined) {  
  warn('#2: x = [0,,2,,4]; x.length = 4; x.length = 3; x[3] === undefined. Actual: ' + (x[3]));    
}

//CHECK#3
if (x[2] !== 2) {  
  warn('#3: x = [0,,2,,4]; x.length = 4; x.length = 3; x[2] === 2. Actual: ' + (x[2]));    
}
