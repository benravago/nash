...
if (x.hasOwnProperty('2') !== false) {  
  warn('#1: Array.prototype[2] = 2; x = [0,1]; x.length = 3; x.hasOwnProperty(\'2\') === false. Actual: ' + (x.hasOwnProperty('2')));    
}

//CHECK#2
x.length = 2;
if (x[2] !== 2) {  
  warn('#2: Array.prototype[2] = 2; x = [0,1]; x.length = 3; x.length = 2; x[2] === 2. Actual: ' + (x[2]));    
}
