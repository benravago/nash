...
// CHECK#0
if (obj === undefined) {
  warn('#0: new Object(null) return the newly created native object.');
}

// CHECK#1
if (obj.constructor !== Object) {
  warn('#1: new Object(null) create a new native ECMAScript object');
}

// CHECK#2
if (!(Object.prototype.isPrototypeOf(obj))) {
  warn('#2: when new Object(null) calls the [[Prototype]] property of the newly constructed object is set to the Object prototype object.');
}

// CHECK#3
var to_string_result = '[object '+ 'Object' +']';
if (obj.toString() !== to_string_result) {
  warn('#3: when new Object(null) calls the [[Class]] property of the newly constructed object is set to "Object".');
}

// CHECK#4
if (obj.valueOf().toString() !== to_string_result.toString()) {
  warn('#4: when new Object(null) calls the newly constructed object has no [[Value]] property.');
}
