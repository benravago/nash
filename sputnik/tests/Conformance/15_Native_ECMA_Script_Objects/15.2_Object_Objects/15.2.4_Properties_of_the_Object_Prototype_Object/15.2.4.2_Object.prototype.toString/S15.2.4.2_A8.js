...
if (Object.prototype.toString.propertyIsEnumerable('length')) {
  warn('#1: the Object.prototype.toString.length property has the attributes DontEnum');
}

// CHECK#2
for (var p in Object.prototype.toString){
  if (p==="length")
        warn('#2: the Object.prototype.toString.length property has the attributes DontEnum');
}
//
