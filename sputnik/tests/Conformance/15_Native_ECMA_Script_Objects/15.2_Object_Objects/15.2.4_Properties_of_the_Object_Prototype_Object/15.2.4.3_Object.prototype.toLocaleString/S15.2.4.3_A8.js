...
if (Object.prototype.toLocaleString.propertyIsEnumerable('length')) {
  warn('#1: the Object.prototype.toLocaleString.length property has the attributes DontEnum');
}

// CHECK#2
for (p in Object.prototype.toLocaleString){
  if (p==="length")
        warn('#2: the Object.prototype.toLocaleString.length property has the attributes DontEnum');
}
//
