...
if (Object.prototype.isPrototypeOf.propertyIsEnumerable('length')) {
  warn('#1: the Object.prototype.isPrototypeOf.length property has the attributes DontEnum');
}

// CHECK#2
for (p in Object.prototype.isPrototypeOf){
  if (p==="length")
        warn('#2: the Object.prototype.isPrototypeOf.length property has the attributes DontEnum');
}
//
