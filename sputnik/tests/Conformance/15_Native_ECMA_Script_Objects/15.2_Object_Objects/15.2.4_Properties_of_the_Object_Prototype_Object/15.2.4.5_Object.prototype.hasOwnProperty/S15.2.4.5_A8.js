...
if (Object.prototype.hasOwnProperty.propertyIsEnumerable('length')) {
  warn('#1: the Object.prototype.hasOwnProperty.length property has the attributes DontEnum');
}

// CHECK#2
for (p in Object.prototype.hasOwnProperty){
  if (p==="length")
        warn('#2: the Object.prototype.hasOwnProperty.length property has the attributes DontEnum');
}
//
