...
if (Object.prototype.valueOf.propertyIsEnumerable('length')) {
  warn('#1: the Object.prototype.valueOf.length property has the attributes DontEnum');
}

// CHECK#2
for (p in Object.prototype.valueOf){
  if (p==="length")
        warn('#2: the Object.prototype.valueOf.length property has the attributes DontEnum');
}
//
