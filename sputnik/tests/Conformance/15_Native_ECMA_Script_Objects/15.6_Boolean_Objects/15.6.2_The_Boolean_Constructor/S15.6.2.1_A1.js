...
if (typeof new Boolean() !== "object") {
  warn("#1: typeof new Boolean() === 'object'");
}

//CHECK#2
if (new Boolean() === undefined) {
  warn("#2: new Boolean() should not be undefined");
}

//CHECK#3
var x3 = new Boolean();
if(typeof x3 !== "object"){
  warn("#3: typeof new Boolean() !== 'object'");
}

//CHECK#4
var x4 = new Boolean();
if(x4 === undefined){
  warn("#4: new Boolean() should not be undefined");
}

//CHECK#5
if (typeof new Boolean(1) !== "object") {
  warn("#5: typeof new Boolean(10) === 'object'");
}

//CHECK#6
if (new Boolean(1) === undefined) {
  warn("#6: new Boolean(1) should not be undefined");
}

//CHECK#7
var x7 = new Boolean(1);
if(typeof x7 !== "object"){
  warn("#7: typeof new Boolean(1) !== 'object'");
}

//CHECK#8
var x8 = new Boolean(1);
if(x8 === undefined){
  warn("#8: new Boolean(1) should not be undefined");
}
