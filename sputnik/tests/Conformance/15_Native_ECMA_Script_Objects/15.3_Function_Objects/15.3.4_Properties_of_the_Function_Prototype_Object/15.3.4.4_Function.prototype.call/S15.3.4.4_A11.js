...
if (Function.prototype.call.propertyIsEnumerable('length')) {
  warn('#1: the Function.prototype.call.length property has the attributes DontEnum');
}

// CHECK#2
for (p in Function.prototype.call){
  if (p==="length")
    warn('#2: the Function.prototype.call.length property has the attributes DontEnum');
}
