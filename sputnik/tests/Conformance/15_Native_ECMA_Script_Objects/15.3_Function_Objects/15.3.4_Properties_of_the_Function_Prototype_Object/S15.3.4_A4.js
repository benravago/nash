...
if (Function.prototype.hasOwnProperty("valueOf") !== false) {
  warn('#1: The Function prototype object does not have a valueOf property of its own');
}

//CHECK#2
if (typeof Function.prototype.valueOf === "undefined") {
  warn('#2: however, it inherits the valueOf property from the Object prototype Object');
}

//CHECK#3
if (Function.prototype.valueOf !== Object.prototype.valueOf) {
  warn('#3: however, it inherits the valueOf property from the Object prototype Object');
}
