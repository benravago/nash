...
if (Function.prototype.apply.propertyIsEnumerable('length')) {
  warn('#1: the Function.prototype.apply.length property has the attributes DontEnum');
}

// CHECK#2
for (var p in Function.prototype.apply){
  if (p==="length")
      warn('#2: the Function.prototype.apply.length property has the attributes DontEnum');
}
