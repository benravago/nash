...
if (Function.prototype.toString.propertyIsEnumerable('length')) {
  warn('#1: the Function.prototype.toString.length property has the attributes DontEnum');
}

// CHECK#2
for (p in Function.prototype.toString){
  if (p==="length")
      warn('#2: the Function.prototype.toString.length property has the attributes DontEnum');
}
