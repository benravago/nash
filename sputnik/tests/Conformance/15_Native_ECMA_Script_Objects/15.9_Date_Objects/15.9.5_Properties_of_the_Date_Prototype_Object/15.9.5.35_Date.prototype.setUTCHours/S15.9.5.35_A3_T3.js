...
if (Date.prototype.setUTCHours.propertyIsEnumerable('length')) {
  warn('#1: The Date.prototype.setUTCHours.length property has the attribute DontEnum');
}

for(x in Date.prototype.setUTCHours) {
  if(x === "length") {
    warn('#2: The Date.prototype.setUTCHours.length has the attribute DontEnum');
  }
}
