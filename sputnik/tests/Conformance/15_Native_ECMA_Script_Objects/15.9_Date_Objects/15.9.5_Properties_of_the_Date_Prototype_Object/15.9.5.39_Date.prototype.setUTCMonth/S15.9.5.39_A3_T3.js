...
if (Date.prototype.setUTCMonth.propertyIsEnumerable('length')) {
  warn('#1: The Date.prototype.setUTCMonth.length property has the attribute DontEnum');
}

for(x in Date.prototype.setUTCMonth) {
  if(x === "length") {
    warn('#2: The Date.prototype.setUTCMonth.length has the attribute DontEnum');
  }
}
