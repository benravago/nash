...
if (Date.prototype.constructor.propertyIsEnumerable('length')) {
  warn('#1: The Date.prototype.constructor.length property has the attribute DontEnum');
}

for(x in Date.prototype.constructor) {
  if(x === "length") {
    warn('#2: The Date.prototype.constructor.length has the attribute DontEnum');
  }
}
