...
if (Date.prototype.propertyIsEnumerable('setUTCMilliseconds')) {
  warn('#1: The Date.prototype.setUTCMilliseconds property has the attribute DontEnum');
}

for(x in Date.prototype) {
  if(x === "setUTCMilliseconds") {
    warn('#2: The Date.prototype.setUTCMilliseconds has the attribute DontEnum');
  }
}
