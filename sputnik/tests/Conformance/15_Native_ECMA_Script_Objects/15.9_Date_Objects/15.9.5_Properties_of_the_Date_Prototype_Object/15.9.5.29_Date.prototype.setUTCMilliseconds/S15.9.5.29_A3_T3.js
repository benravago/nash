...
if (Date.prototype.setUTCMilliseconds.propertyIsEnumerable('length')) {
  warn('#1: The Date.prototype.setUTCMilliseconds.length property has the attribute DontEnum');
}

for(x in Date.prototype.setUTCMilliseconds) {
  if(x === "length") {
    warn('#2: The Date.prototype.setUTCMilliseconds.length has the attribute DontEnum');
  }
}
