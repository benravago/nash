...
if (Date.prototype.getFullYear.propertyIsEnumerable('length')) {
  warn('#1: The Date.prototype.getFullYear.length property has the attribute DontEnum');
}

for(x in Date.prototype.getFullYear) {
  if(x === "length") {
    warn('#2: The Date.prototype.getFullYear.length has the attribute DontEnum');
  }
}
