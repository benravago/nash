...
if (Date.prototype.toLocaleTimeString.propertyIsEnumerable('length')) {
  warn('#1: The Date.prototype.toLocaleTimeString.length property has the attribute DontEnum');
}

for(x in Date.prototype.toLocaleTimeString) {
  if(x === "length") {
    warn('#2: The Date.prototype.toLocaleTimeString.length has the attribute DontEnum');
  }
}
