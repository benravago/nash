...
if (Date.prototype.propertyIsEnumerable('toLocaleTimeString')) {
  warn('#1: The Date.prototype.toLocaleTimeString property has the attribute DontEnum');
}

for(x in Date.prototype) {
  if(x === "toLocaleTimeString") {
    warn('#2: The Date.prototype.toLocaleTimeString has the attribute DontEnum');
  }
}
