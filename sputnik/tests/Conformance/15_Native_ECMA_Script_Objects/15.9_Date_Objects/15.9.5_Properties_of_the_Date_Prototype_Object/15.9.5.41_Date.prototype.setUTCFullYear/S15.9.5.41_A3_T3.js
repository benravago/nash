...
if (Date.prototype.setUTCFullYear.propertyIsEnumerable('length')) {
  warn('#1: The Date.prototype.setUTCFullYear.length property has the attribute DontEnum');
}

for(x in Date.prototype.setUTCFullYear) {
  if(x === "length") {
    warn('#2: The Date.prototype.setUTCFullYear.length has the attribute DontEnum');
  }
}
