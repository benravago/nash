...
if (Date.prototype.propertyIsEnumerable('getUTCMilliseconds')) {
  warn('#1: The Date.prototype.getUTCMilliseconds property has the attribute DontEnum');
}

for(x in Date.prototype) {
  if(x === "getUTCMilliseconds") {
    warn('#2: The Date.prototype.getUTCMilliseconds has the attribute DontEnum');
  }
}
