...
if (Date.prototype.setFullYear.propertyIsEnumerable('length')) {
  warn('#1: The Date.prototype.setFullYear.length property has the attribute DontEnum');
}

for(x in Date.prototype.setFullYear) {
  if(x === "length") {
    warn('#2: The Date.prototype.setFullYear.length has the attribute DontEnum');
  }
}
