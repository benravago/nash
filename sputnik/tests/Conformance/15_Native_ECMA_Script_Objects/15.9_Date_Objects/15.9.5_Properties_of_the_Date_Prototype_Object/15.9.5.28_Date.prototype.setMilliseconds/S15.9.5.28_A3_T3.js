...
if (Date.prototype.setMilliseconds.propertyIsEnumerable('length')) {
  warn('#1: The Date.prototype.setMilliseconds.length property has the attribute DontEnum');
}

for(x in Date.prototype.setMilliseconds) {
  if(x === "length") {
    warn('#2: The Date.prototype.setMilliseconds.length has the attribute DontEnum');
  }
}
