...
if (!Date.prototype.isPrototypeOf(x12)) {
  warn('#1.2: Date.prototype.isPrototypeOf(x12)');
}
...
if (!Date.prototype.isPrototypeOf(x22)) {
  warn('#2.2: Date.prototype.isPrototypeOf(x22)');
}
...
if (!Date.prototype.isPrototypeOf(x32)) {
  warn('#3.2: Date.prototype.isPrototypeOf(x32)');
}
...
if (!Date.prototype.isPrototypeOf(x42)) {
  warn('#4.2: Date.prototype.isPrototypeOf(x42)');
}
...
if (!Date.prototype.isPrototypeOf(x52)) {
  warn('#5.2: Date.prototype.isPrototypeOf(x52)');
}
...
if (!Date.prototype.isPrototypeOf(x62)) {
  warn('#6.2: Date.prototype.isPrototypeOf(x62)');
}
...
if (!Date.prototype.isPrototypeOf(x72)) {
  warn('#7.2: Date.prototype.isPrototypeOf(x72)');
}
...
if (!Date.prototype.isPrototypeOf(x82)) {
  warn('#8.2: Date.prototype.isPrototypeOf(x82)');
}
...
if (!Date.prototype.isPrototypeOf(x92)) {
  warn('#9.2: Date.prototype.isPrototypeOf(x92)');
}
...
if (!Date.prototype.isPrototypeOf(x102)) {
  warn('#10.2: Date.prototype.isPrototypeOf(x102)');
}
...
if (!Date.prototype.isPrototypeOf(x112)) {
  warn('#11.2: Date.prototype.isPrototypeOf(x112)');
}
...
if (!Date.prototype.isPrototypeOf(x122)) {
  warn('#12.2: Date.prototype.isPrototypeOf(x122)');
}
