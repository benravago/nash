...
try{
  ...
  warn("#1: The 1st step is calling ToNumber(year)");
}
catch(e){
  if(e !== "valueOf-1"){
    warn("#1: The 1st step is calling ToNumber(year)");
...
try{
  ...
  warn("#2: The 2nd step is calling ToNumber(month)");
}
catch(e){
  if(e !== "valueOf-2"){
    warn("#2: The 2nd step is calling ToNumber(month)");
...
try{
  ...
  warn("#3: The 3rd step is calling ToNumber(date)");
}
catch(e){
  if(e !== "valueOf-3"){
    warn("#3: The 3rd step is calling ToNumber(date)");
...
try{
  ...
  warn("#4: The 4th step is calling ToNumber(hours)");
}
catch(e){
  if(e !== "valueOf-4"){
    warn("#4: The 4th step is calling ToNumber(hours)");
...
try{
  ...
  warn("#5: The 5th step is calling ToNumber(minutes)");
}
catch(e){
  if(e !== "valueOf-5"){
    warn("#5: The 5th step is calling ToNumber(minutes)");
...
try{
  ...
  warn("#6: The 6th step is calling ToNumber(seconds)");
}
catch(e){
  if(e !== "valueOf-6"){
    warn("#6: The 6th step is calling ToNumber(seconds)");
...
try{
  ...
  warn("#7: The 7th step is calling ToNumber(ms)");
}
catch(e){
  if(e !== "valueOf-7"){
    warn("#7: The 7th step is calling ToNumber(ms)");
