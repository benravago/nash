...
if (__instance.first !== undefined) {
	warn('#1: __instance.first === undefined. Actual: __instance.first ==='+__instance.first);
}
//
//////////////////////////////////////////////////////////////////////////////
...
if (__instance.prop!==__SCND) {
	warn('#2: __instance.prop === __SCND. Actual: __instance.prop ==='+__instance.prop);
}
//
//////////////////////////////////////////////////////////////////////////////
...
if (__instance("SAM")!== "SAMBA") {
	warn('#2: __instance("SAM") === "SAMBA". Actual: __instance("SAM") ==='+__instance("SAM"));
}
//
//////////////////////////////////////////////////////////////////////////////
