...
if ((undefined == undefined) !== true) {
  warn('#1: (undefined == undefined) === true');
}

//CHECK#2
if ((void 0 == undefined) !== true) {
  warn('#2: (void 0 == undefined) === true');
}

//CHECK#3
if ((undefined == eval("var x")) !== true) {
  warn('#3: (undefined == eval("var x")) === true');
}

//CHECK#4
if ((undefined == null) !== true) {
  warn('#4: (undefined == null) === true');
}

//CHECK#5
if ((null == void 0) !== true) {
  warn('#5: (null == void 0) === true');
}

//CHECK#6
if ((null == null) !== true) {
  warn('#6: (null == null) === true');
}
