...
//CHECK#1
if (typeof 1 !== "number") {
  warn('#1: typeof 1 === "number". Actual: ' + (typeof 1));
}

//CHECK#2
if (typeof Number.NaN !== "number") {
  warn('#2: typeof NaN === "number". Actual: ' + (typeof NaN));
}

//CHECK#3
if (typeof Number.POSITIVE_INFINITY !== "number") {
  warn('#3: typeof Infinity === "number". Actual: ' + (typeof Infinity));
}

//CHECK#4
if (typeof Number.NEGATIVE_INFINITY !== "number") {
  warn('#4: typeof -Infinity === "number". Actual: ' + (typeof -Infinity));
}

//CHECK#5
if (typeof Math.PI !== "number") {
  warn('#5: typeof Math.PI === "number". Actual: ' + (typeof Math.PI));
}
