...
if (--object !== 1 - 1) {
  warn('#1: var object = {valueOf: function() {return 1}}; --object === 1 - 1. Actual: ' + (--object));
} else {
  if (object !== 1 - 1) {
...
if (--object !== 1 - 1) {
  warn('#2: var object = {valueOf: function() {return 1}, toString: function() {return 0}}; --object === 1 - 1. Actual: ' + (--object));
} else {
  if (object !== 1 - 1) {
...
if (--object !== 1 - 1) {
  warn('#3: var object = {valueOf: function() {return 1}, toString: function() {return {}}}; --object === 1 - 1. Actual: ' + (--object));
} else {
  if (object !== 1 - 1) {
...
try {
  ...
  if (--object !== 1 - 1) {
    warn('#4.1: var object = {valueOf: function() {return 1}, toString: function() {throw "error"}}; --object === 1 - 1. Actual: ' + (--object));
  } else {
    if (object !== 1 - 1) {
      warn('#4.1: var object = {valueOf: function() {return 1}, toString: function() {throw "error"}}; --object; object === 1 - 1. Actual: ' + (object));
    }
  }
}
catch (e) {
...
if (--object !== 1 - 1) {
  warn('#5.1: var object = {toString: function() {return 1}}; --object === 1 - 1. Actual: ' + (--object));
} else {
  if (object !== 1 - 1) {
...
if (--object !== 1 - 1) {
  warn('#6.1: var object = {valueOf: function() {return {}}, toString: function() {return 1}}; --object === 1 - 1. Actual: ' + (--object));
} else {
  if (object !== 1 - 1) {
...
try {
  ...
  --object;
  warn('#7.1: var object = {valueOf: function() {throw "error"}, toString: function() {return 1}}; --object throw "error". Actual: ' + (--object));
}  
catch (e) {
  if (e !== "error") {
...
try {
  ...
  --object;
  warn('#8.1: var object = {valueOf: function() {return {}}, toString: function() {return {}}}; --object throw TypeError. Actual: ' + (--object));
}  
catch (e) {
