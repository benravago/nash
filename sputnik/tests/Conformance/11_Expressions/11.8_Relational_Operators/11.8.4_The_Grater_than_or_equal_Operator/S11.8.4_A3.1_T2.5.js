...
if (new Boolean(true) >= "1" !== true) {
  warn('#3: new Boolean(true) >= "1" === true');
}

//CHECK#4
if ("1" >= new Boolean(true) !== true) {
  warn('#4: "1" >= new Boolean(true) === true');
}

//CHECK#5
if (true >= new String("1") !== true) {
  warn('#5: true >= new String("1") === true');
}

//CHECK#6
if (new String("1") >= true !== true) {
  warn('#6: new String("1") >= true === true');
}

//CHECK#7
if (new Boolean(true) >= new String("1") !== true) {
  warn('#7: new Boolean(true) >= new String("1") === true');
}

//CHECK#8
if (new String("1") >= new Boolean(true) !== true) {
  warn('#8: new String("1") >= new Boolean(true) === true');
}
