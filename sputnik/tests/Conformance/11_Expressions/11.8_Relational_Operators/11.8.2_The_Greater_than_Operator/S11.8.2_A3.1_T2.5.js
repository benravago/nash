...
if (new Boolean(true) > "1" !== false) {
  warn('#3: new Boolean(true) > "1" === false');
}

//CHECK#4
if ("1" > new Boolean(true) !== false) {
  warn('#4: "1" > new Boolean(true) === false');
}

//CHECK#5
if (true > new String("1") !== false) {
  warn('#5: true > new String("1") === false');
}

//CHECK#6
if (new String("1") > true !== false) {
  warn('#6: new String("1") > true === false');
}

//CHECK#7
if (new Boolean(true) > new String("1") !== false) {
  warn('#7: new Boolean(true) > new String("1") === false');
}

//CHECK#8
if (new String("1") > new Boolean(true) !== false) {
  warn('#8: new String("1") > new Boolean(true) === false');
}
