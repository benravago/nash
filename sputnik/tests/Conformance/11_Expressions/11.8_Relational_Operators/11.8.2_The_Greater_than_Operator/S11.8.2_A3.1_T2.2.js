...
if (new String("1") > 1 !== false) {
  warn('#3: new String("1") > 1 === false');
}

//CHECK#4
if (1 > new String("1") !== false) {
  warn('#4: 1 > new String("1") === false');
}

//CHECK#5
if ("1" > new Number(1) !== false) {
  warn('#5: "1" > new Number(1) === false');
}

//CHECK#6
if (new Number(1) > "1" !== false) {
  warn('#6: new Number(1) > "1" === false');
}

//CHECK#7
if (new String("1") > new Number(1) !== false) {
  warn('#7: new String("1") > new Number(1) === false');
}

//CHECK#8
if (new Number(1) > new String("1") !== false) {
  warn('#8: new Number(1) > new String("1") === false');
}
