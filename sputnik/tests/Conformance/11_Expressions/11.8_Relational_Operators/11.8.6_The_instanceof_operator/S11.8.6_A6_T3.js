...
if (MyFunct instanceof MyFunct){
	warn('#1 function MyFunct(){return 0}; MyFunct instanceof MyFunct === false');
}

//CHECK#2
if (MyFunct instanceof Function !== true){
	warn('#2 function MyFunct(){return 0}; MyFunct instanceof Function === true');
}

//CHECK#3
if (MyFunct instanceof Object !== true){
	warn('#3 function MyFunct(){return 0}; MyFunct instanceof Object === true');
}
