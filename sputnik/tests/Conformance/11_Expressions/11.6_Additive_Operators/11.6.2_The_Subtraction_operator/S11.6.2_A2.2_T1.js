...
if ({valueOf: function() {return 1}} - 1 !== 0) {
  warn('#1: {valueOf: function() {return 1}} - 1 === 0. Actual: ' + ({valueOf: function() {return 1}} - 1));
}

//CHECK#2
if ({valueOf: function() {return 1}, toString: function() {return 0}} - 1 !== 0) {
  warn('#2: {valueOf: function() {return 1}, toString: function() {return 0}} - 1 === 0. Actual: ' + ({valueOf: function() {return 1}, toString: function() {return 0}} - 1));
}

//CHECK#3
if ({valueOf: function() {return 1}, toString: function() {return {}}} - 1 !== 0) {
  warn('#3: {valueOf: function() {return 1}, toString: function() {return {}}} - 1 === 0. Actual: ' + ({valueOf: function() {return 1}, toString: function() {return {}}} - 1));
}

//CHECK#4
try {
  if ({valueOf: function() {return 1}, toString: function() {throw "error"}} - 1 !== 0) {
    warn('#4.1: {valueOf: function() {return 1}, toString: function() {throw "error"}} - 1 === 0. Actual: ' + ({valueOf: function() {return 1}, toString: function() {throw "error"}} - 1));
  }
}
catch (e) {
  if (e === "error") {
...
if (1 - {toString: function() {return 1}} !== 0) {
  warn('#5: 1 - {toString: function() {return 1}} === 0. Actual: ' + (1 - {toString: function() {return 1}}));
}

//CHECK#6
if (1 - {valueOf: function() {return {}}, toString: function() {return 1}} !== 0) {
  warn('#6: 1 - {valueOf: function() {return {}}, toString: function() {return 1}} === 0. Actual: ' + (1 - {valueOf: function() {return {}}, toString: function() {return 1}}));
}
