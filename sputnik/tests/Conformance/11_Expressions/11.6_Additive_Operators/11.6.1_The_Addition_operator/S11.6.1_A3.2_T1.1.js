...
if (new String("1") + "1" !== "11") {
  warn('#2: new String("1") + "1" === "11". Actual: ' + (new String("1") + "1"));
}

//CHECK#3
if ("1" + new String("1") !== "11") {
  warn('#3: "1" + new String("1") === "11". Actual: ' + ("1" + new String("1")));
}

//CHECK#4
if (new String("1") + new String("1") !== "11") {
  warn('#4: new String("1") + new String("1") === "11". Actual: ' + (new String("1") + new String("1")));
}

//CHECK#5
if ("x" + "1" !=="x1") {
  warn('#5: "x" + "1" === "x1". Actual: ' + ("x" + "1"));
}

//CHECK#6
if ("1" + "x" !== "1x") {
  warn('#6: "1" + "x" === "1x". Actual: ' + ("1" + "x"));
}
