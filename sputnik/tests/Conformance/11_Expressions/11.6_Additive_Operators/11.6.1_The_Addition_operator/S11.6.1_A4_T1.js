...
if (isNaN(Number.NaN + 1) !== true ) {
  warn('#1: NaN + 1 === Not-a-Number. Actual: ' + (NaN + 1));
}

//CHECK#2
if (isNaN(1 + Number.NaN) !== true ) {
  warn('#2: 1 + NaN === Not-a-Number. Actual: ' + (1 + NaN));
}

//CHECK#3
if (isNaN(Number.NaN + Number.POSITIVE_INFINITY) !== true ) {
  warn('#3: NaN + Infinity === Not-a-Number. Actual: ' + (NaN + Infinity));
}
...
if (isNaN(Number.NEGATIVE_INFINITY + Number.NaN) !== true ) {
  warn('#6: Infinity + NaN === Not-a-Number. Actual: ' + (Infinity + NaN));
}
