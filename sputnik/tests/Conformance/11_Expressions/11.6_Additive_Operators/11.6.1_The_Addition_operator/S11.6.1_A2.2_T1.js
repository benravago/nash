...
if ({valueOf: function() {return 1}} + 1 !== 2) {
  warn('#1: {valueOf: function() {return 1}} + 1 === 2. Actual: ' + ({valueOf: function() {return 1}} + 1));
}

//CHECK#2
if ({valueOf: function() {return 1}, toString: function() {return 0}} + 1 !== 2) {
  warn('#2: {valueOf: function() {return 1}, toString: function() {return 0}} + 1 === 2. Actual: ' + ({valueOf: function() {return 1}, toString: function() {return 0}} + 1));
}

//CHECK#3
if ({valueOf: function() {return 1}, toString: function() {return {}}} + 1 !== 2) {
  warn('#3: {valueOf: function() {return 1}, toString: function() {return {}}} + 1 === 2. Actual: ' + ({valueOf: function() {return 1}, toString: function() {return {}}} + 1));
}

//CHECK#4
try {
  if ({valueOf: function() {return 1}, toString: function() {throw "error"}} + 1 !== 2) {
    warn('#4.1: {valueOf: function() {return 1}, toString: function() {throw "error"}} + 1 === 2. Actual: ' + ({valueOf: function() {return 1}, toString: function() {throw "error"}} + 1));
  }
}
catch (e) {
  if (e === "error") {
...
if (1 + {toString: function() {return 1}} !== 2) {
  warn('#5: 1 + {toString: function() {return 1}} === 2. Actual: ' + (1 + {toString: function() {return 1}}));
}

//CHECK#6
if (1 + {valueOf: function() {return {}}, toString: function() {return 1}} !== 2) {
  warn('#6: 1 + {valueOf: function() {return {}}, toString: function() {return 1}} === 2. Actual: ' + (1 + {valueOf: function() {return {}}, toString: function() {return 1}}));
}
