...
try {
  null.toString();
  warn('#1.1: null.toString() throw TypeError. Actual: ' + (null.toString()));  
}
catch (e) {
  if ((e instanceof TypeError) !== true) {
    warn('#1.2: null.toString() throw TypeError. Actual: ' + (e));  
  }
}
...
try {  
  null["toString"]();
  warn('#2.1: null["toString"]() throw TypeError. Actual: ' + (null["toString"]())); 
}
catch (e) {
  if ((e instanceof TypeError) !== true) {
    warn('#2.2: null["toString"]() throw TypeError. Actual: ' + (e)); 
  }
}
