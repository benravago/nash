...
if (Number("1234567890.1234567890") !== 1234567890.1234567890)  {
  warn('#1: Number("1234567890.1234567890") === 1234567890.1234567890. Actual: ' + (Number("1234567890.1234567890")));
}

// CHECK#2
if (Number("1234567890.1234567890") !== 1234567890.1234567000)  {
  warn('#2: Number("1234567890.1234567890") === 1234567890.1234567000. Actual: ' + (Number("1234567890.1234567890")));
}

// CHECK#3
if (+("1234567890.1234567890") === 1234567890.123456) {
  warn('#3: +("1234567890.1234567890") !== 1234567890.123456');
}

// CHECK#4
if (Number("0.12345678901234567890") !== 0.123456789012345678)  {
  warn('#4: Number("0.12345678901234567890") === 0.123456789012345678. Actual: ' + (Number("0.12345678901234567890")));
}

// CHECK#4
if (Number("00.12345678901234567890") !== 0.123456789012345678)  {
  warn('#4: Number("00.12345678901234567890") === 0.123456789012345678. Actual: ' + (Number("00.12345678901234567890")));
}
