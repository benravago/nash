...
if (isNaN(Number(undefined)) !== true) {
  warn('#1: Number(undefined) === Not-a-Number. Actual: ' + (Number(undefined)));
}

// CHECK#2
if (isNaN(Number(void 0)) !== true) {
  warn('#2: Number(void 0) === Not-a-Number. Actual: ' + (Number(void 0)));
}

// CHECK#3
if (isNaN(Number(eval("var x"))) !== true) {
  warn('#3: Number(eval("var x")) === Not-a-Number. Actual: ' + (Number(eval("var x"))));
}
