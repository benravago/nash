...
if (String(undefined) !== "undefined") {
  warn('#1: String(undefined) === "undefined". Actual: ' + (String(undefined)));
}

// CHECK#2
if (String(void 0) !== "undefined") {
  warn('#2: String(void 0) === "undefined". Actual: ' + (String(void 0)));
}

// CHECK#3
if (String(eval("var x")) !== "undefined") {
  warn('#3: String(eval("var x")) === "undefined" . Actual: ' + (String(eval("var x"))));
}
