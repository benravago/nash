...
if (String(1.2345) !== "1.2345") {
  warn('#1: String(1.2345) === "1.2345". Actual: ' + (String(1.2345)));
}

// CHECK#2
if (String(1.234567890) !== "1.23456789") {
  warn('#2: String(1.234567890) === "1.23456789". Actual: ' + (String(1.234567890)));
}

// CHECK#3
if (String(0.12345) !== "0.12345") {
  warn('#3: String(0.12345) === "0.12345". Actual: ' + (String(0.12345)));
}

// CHECK#4
if (String(.012345) !== "0.012345") {
  warn('#4: String(.012345) === "0.012345". Actual: ' + (String(.012345)));
}

// CHECK#5
if (String(.0012345) !== "0.0012345") {
  warn('#5: String(.0012345) === "0.0012345". Actual: ' + (String(.0012345)));
}

// CHECK#6
if (String(.00012345) !== "0.00012345") {
  warn('#6: String(.00012345) === "0.00012345". Actual: ' + (String(.00012345)));
}

// CHECK#7
if (String(.000012345) !== "0.000012345") {
  warn('#7: String(.000012345) === "0.000012345". Actual: ' + (String(.000012345)));
}

// CHECK#8
if (String(.0000012345) !== "0.0000012345") {
  warn('#8: String(.0000012345) === "0.0000012345". Actual: ' + (String(.0000012345)));
}

// CHECK#9
if (String(.00000012345) !== "1.2345e-7") {
  warn('#9: String(.00000012345) === "1.2345e-7". Actual: ' + (String(.00000012345)));
}
