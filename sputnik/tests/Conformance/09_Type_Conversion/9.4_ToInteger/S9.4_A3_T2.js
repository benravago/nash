...
if (!isNaN(d1.valueOf())) {
  warn('#1: var d1 = new Date(Number.NaN); d1.valueOf() === Number.NaN;');
}

// CHECK#2
var d2 = new Date(Infinity);
if (!isNaN(d2.valueOf())) {
  warn('#2: var d2 = new Date(Infinity); d2.valueOf() === Number.NaN;');
}

// CHECK#3
var d3 = new Date(-Infinity);
if (!isNaN(d3.valueOf())) {
  warn('#3: var d3 = new Date(-Infinity); d3.valueOf() === Number.NaN;');
}

// CHECK#4
var d4 = new Date(0);
if (d4.valueOf() !== 0) {
  warn('#4: var d4 = new Date(0); d4.valueOf() === 0;');
}

// CHECK#5
var d5 = new Date(-0);
if (d5.valueOf() !== -0) {
  warn('#5: var d5 = new Date(-0); d5.valueOf() === -0;');
}
