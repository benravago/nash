...
if (Boolean(Number.POSITIVE_INFINITY) !== true) {
  warn('#1: Boolean(+Infinity) === true. Actual: ' + (Boolean(+Infinity))); 	
}

// CHECK#2;
if (Boolean(Number.NEGATIVE_INFINITY) !== true) {
  warn('#2: Boolean(-Infinity) === true. Actual: ' + (Boolean(-Infinity))); 	
}

// CHECK#3
if (Boolean(Number.MAX_VALUE) !== true) {
  warn('#3: Boolean(Number.MAX_VALUE) === true. Actual: ' + (Boolean(Number.MAX_VALUE))); 	
}

// CHECK#4
if (Boolean(Number.MIN_VALUE) !== true) {
  warn('#4: Boolean(Number.MIN_VALUE) === true. Actual: ' + (Boolean(Number.MIN_VALUE))); 	
}

// CHECK#5
if (Boolean(13) !== true) {
  warn('#5: Boolean(13) === true. Actual: ' + (Boolean(13)));	
}

// CHECK#6
if (Boolean(-13) !== true) {
  warn('#6: Boolean(-13) === true. Actual: ' + (Boolean(-13)));	
}

// CHECK#7
if (Boolean(1.3) !== true) {
  warn('#7: Boolean(1.3) === true. Actual: ' + (Boolean(1.3)));	
}

// CHECK#8
if (Boolean(-1.3) !== true) {
  warn('#8: Boolean(-1.3) === true. Actual: ' + (Boolean(-1.3)));	
}	
