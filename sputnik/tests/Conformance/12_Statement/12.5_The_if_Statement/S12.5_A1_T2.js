...
//CHECK#1
if(!(1))
	warn('#1.1: 1 in expression is evaluated to true');
else
  c++;
...
//CHECK#2
if(!(true))
	warn('#2.1: true in expression is evaluated to true');
else
  c++;
...
//CHECK#3
if(!("1"))
	warn('#3.1: "1" in expression is evaluated to true');
else
  c++;
...
//CHECK#4
if(!("A"))
	warn('#4.1: "A" in expression is evaluated to true');
else
  c++;
