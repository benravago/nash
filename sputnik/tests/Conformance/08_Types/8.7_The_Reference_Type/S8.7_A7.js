...
//CHECK#1
if (typeof m !== "object") {
  warn('#1: var n = {}; var m = n; typeof m === "object". Actual: ' + (typeof m));
}
//
//////////////////////////////////////////////////////////////////////////////
...
//CHECK#2
if (n.age !== 50) {
  warn('#2: var n = {}; var m = n; function populateAge(person){person.age = 50;} populateAge(m); n.age === 50. Actual: ' + (n.age));
}
